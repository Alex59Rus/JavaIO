...
import static com.alex.io.LabelRepository.labelsDirFile;
...
public class WriterController implements Serializable {
    ...
    public static void writingDataIntoFile() {
        try {
            FileWriter writer = new FileWriter(labelsDirFile,true);
    ...
    public static void deleteDataFromFile() {

    }
    public static void changeDataIntoFile() {
